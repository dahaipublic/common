...
type HotMatch struct {
	...
	QueryTime  int64  `json:"queryTime" gorm:"column:query_time;index:index_query_time;default:0;not null;comment:" `
}

type HotMatchAdmin struct {
	HotMatch
...
func (t HotMatch) TableName() string {
	return "t_hot_match"
}

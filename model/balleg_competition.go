...
// type BallEGCompetition XXCompetition
//
//	func (t BallEGCompetition) TableName() string {
//		return "t_ball_eg_competition"
//	}
type BallEGCompetition struct {
	BasicField
...
type BallEGCompetitionAdmin struct {
